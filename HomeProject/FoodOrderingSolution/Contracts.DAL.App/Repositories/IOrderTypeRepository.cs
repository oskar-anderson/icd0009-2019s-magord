...
namespace Contracts.DAL.App.Repositories
{
    ...
    public interface IOrderTypeRepository : IOrderTypeRepository<Guid, OrderType>, IBaseRepository<OrderType>
    {
        
    }
    public interface IOrderTypeRepository<TKey, TDALEntity> : IBaseRepository<TKey, TDALEntity>
