...
export class App {
    ...
    configureRouter(config: RouterConfiguration, router: Router): void {
        ...
        config.map([
            ...
            { route: ['contacts/delete/:id'], name: 'contacts-delete', moduleId: PLATFORM.moduleName('views/contacts/delete'), nav: false, title: 'Contacts Delete' },
            ...
            {route: ['contacttypes', 'contacttypes/index'], name: 'contacttypes-index', moduleId: PLATFORM.moduleName('views/contacttypes/index'), nav: true, title: 'ContactTypes'},
            ...
            */
            ...
            { route: ['foods/delete/:id'], name: 'foods-delete', moduleId: PLATFORM.moduleName('views/foods/delete'), nav: false, title: 'Foods Delete' },
            { route: ['foods/create'], name: 'foods-create', moduleId: PLATFORM.moduleName('views/foods/create'), nav: false, title: 'Foods Create' },


            {route: ['foodtypes', 'foodtypes/index'], name: 'foodtypes-index', moduleId: PLATFORM.moduleName('views/foodtypes/index'), nav: true, title: 'FoodTypes'},
            ...
            { route: ['ingredients/delete/:id'], name: 'ingredients-delete', moduleId: PLATFORM.moduleName('views/ingredients/delete'), nav: false, title: 'Ingredients Delete' },
            ...
            {route: ['ordertypes', 'ordertypes/index'], name: 'ordertypes-index', moduleId: PLATFORM.moduleName('views/ordertypes/index'), nav: true, title: 'OrderTypes'},
            ...
            {route: ['paymenttypes', 'paymenttypes/index'], name: 'paymenttypes-index', moduleId: PLATFORM.moduleName('views/paymenttypes/index'), nav: true, title: 'PaymentTypes'},
            ...
            { route: ['paymenttypes/delete/:id'], name: 'paymenttypes-delete', moduleId: PLATFORM.moduleName('views/paymenttypes/delete'), nav: false, title: 'Payment Types Delete' },
            ...
            */
            ...
            { route: ['prices/delete/:id'], name: 'prices-delete', moduleId: PLATFORM.moduleName('views/prices/delete'), nav: false, title: 'Prices Delete' },
